...
void Init2SCR(void)
{
   ...
   MON2_outtext("Werkstck - L„nge: ");
   MON2_outtext(buf_l);
   MON2_outtext("mm ³ Druchmesser:");
   MON2_outtext(buf_d);
   MON2_outtext("mm ³ Innendurchmesser:");
   MON2_outtext(buf_id);
   MON2_outtext("mm");

   MON2_settextposition(1,2);
   MON2_outtext("Koordinaten:   X:              Y:            Werkzeug: T01");
   ...
   MON2_outtext(" N ³G/M ³  X/I   ³  Z/K   ³F/L/K/T³ H  ³ Bemerkung");
